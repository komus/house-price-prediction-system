...
```
From the result above, K-Nearest Neighbour has the least RMSE. Therefore, the KNN method will be used to train the full train dataset and the result used to predict SalePrice for test dataset.
```{r}
...
## Conclusion
KNN is used to predict the house prices for the test dataset. Upon calculation the RMSE of the predicted value is 0.26514 which means the prediction model needs to be improved.
